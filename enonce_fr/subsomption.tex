...
Vous devrez également envoyer un email à \url{stephane.doncieux@upmc.fr} avec, en attachement, les modules python que vous avez développé pour chaque question. Vous les accompagnerez de quelques commentaires expliquant vos choix.
